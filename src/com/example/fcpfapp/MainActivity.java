...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		editText[0][0]=(EditText)findViewById(R.id.ddedthnJia);
		editText[0][1]=(EditText)findViewById(R.id.ddedthnYi);
		editText[0][2]=(EditText)findViewById(R.id.ddedthnBin);
		editText[0][3]=(EditText)findViewById(R.id.ddedthnDing);
		editText[1][0]=(EditText)findViewById(R.id.ddedttnJia);
		editText[1][1]=(EditText)findViewById(R.id.edttnYi);
		editText[1][2]=(EditText)findViewById(R.id.ddedttnBin);
		...
		actors_rgp=(RadioGroup)findViewById(R.id.ddradioGroup1);
		radioButtonThree=(RadioButton)findViewById(R.id.ddradio1);
		price_edit=(EditText)findViewById(R.id.ddeidtTextprice);
		ding_view=(TextView)findViewById(R.id.ddtextViewDin);
	  ...
	  class MyOnFocusChangListener implements View.OnFocusChangeListener{
		...
		public void onFocusChange(View v, boolean hanFocus) {
			...
			if(hanFocus)
			{
				...
				{
					if(editText.getId()==R.id.ddeidtTextprice)
